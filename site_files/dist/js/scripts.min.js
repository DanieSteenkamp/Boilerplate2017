...
$(document).ready(function(){var t=$("#sidebar-menu .main-menu"),i=$("#static-content");i.find("h1").each(function(){t.append('<li id="'+$(this).attr("id")+'-menu"><a href="#'+$(this).attr("id")+'">'+$(this).html()+"</li>"),title=t.find("#"+$(this).attr("id"))}),i.find("h2").each(function(){prevTitle=t.find("#"+$(this).prevAll("h1").first().attr("id")+"-menu"),prevTitle.not(":has(ul)").append('<ul class="sub-menu"></ul>'),prevTitle.find(".sub-menu").append('<li id="'+$(this).attr("id")+'-menu"><a href="#'+$(this).attr("id")+'">'+$(this).html()+"</li>")}),t.affix({offset:{top:0}})});
